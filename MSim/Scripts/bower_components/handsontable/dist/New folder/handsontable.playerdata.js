(function (Handsontable) {
    ...
    function HandsontablePlayerData() {
        ...
        var playerDataRenderer = function (instance, TD, row, col, prop, value, cellProperties) {
            if (instance.playerDataEnabled && isPlayerData(value)) {
        ...
        //var afterPlayerDataChange = function (changes, source) {
        //    var instance = this;

        //    if (!instance.playerDataEnabled) {
        //        return;
        //    }
        ...
        //var afterPlayerDataCreateRow = function (row, amount, auto) {
        //    if (auto) {
        //        return;
        //    }
        ...
        //var afterPlayerDataCreateCol = function (col) {
        //    var instance = this;
        ...
        this.init = function () {
            ...
            instance.playerDataEnabled = true;
            if (instance.playerDataEnabled) {
                ...
                Handsontable.cellTypes['playerData'] = playerDataCell;

               // Handsontable.TextCell.renderer = playerDataRenderer;
                
                //instance.addHook('afterChange', afterPlayerDataChange);
                ...
                //instance.removeHook('afterChange', afterPlayerDataChange);
    ...
    var htPlayerData = new HandsontablePlayerData();

    Handsontable.hooks.add('beforeInit', htPlayerData.init);

    Handsontable.hooks.add('afterUpdateSettings', function () {
        htPlayerData.init.call(this, 'afterUpdateSettings')
    });
